...
SLO_NAME="RETAIL - Business Availability"
SLO_TARGET="0.995"
...
echo
echo "=============================================="
echo " INSTANA - BUSINESS SLO"
echo "=============================================="


echo
echo "=== [1/5] Resolviendo Business Synthetic ==="
...
cat > "${CONFIG_DIR}/slo-business.json" <<EOF
{
  "name": "${SLO_NAME}",
  "target": ${SLO_TARGET},
  "lastUpdated": ${NOW_MS},
...
jq . "${CONFIG_DIR}/slo-business.json" >/dev/null
...
echo "${SLO_ID}" > "${STATE_DIR}/slo-business-id"
